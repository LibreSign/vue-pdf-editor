    ...
    >
      ...
      >
        <div v-if="showLineSizeSelect" class="mr-2 flex items-center">
          <img title="行间距" src="../../svg/line_height.svg" class="w-6 mr-2" alt="Line height"/>
          <input
              v-model="lineHeight_"
              type="number"
              min="1"
        ...
        <div v-if="showFontSizeSelect" class="mr-2 flex items-center">
          <img title="字号" src="../../svg/text.svg" class="w-6 mr-2" alt="Font size"/>
          <input
              v-model="size_"
              type="number"
              min="12"
        ...
        <div v-if="showFontSelect" class="mr-2 flex items-center">
          <img title="字体" src="../../svg/text-family.svg" class="w-4 mr-2" alt="Font family"/>
        ...
        <div
            ...
            @click="onDelete">
          <img class="w-full h-full" src="../../svg/delete.svg" title="移除" alt="delete object"/>
        </div>
      </tapout-component>
      <div
          class="
