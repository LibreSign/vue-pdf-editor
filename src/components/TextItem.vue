    ...
    <toolbar-component ref="textItemToolbarComponent" v-if="operation === 'edit' || operation === 'tool'">
      ...
      >
        <div class="mr-2 flex items-center">
          <img title="行间距" src="/line_height.svg" class="w-6 mr-2" alt="Line height"/>
          <input
              v-model="lineHeight_"
              type="number"
              min="1"
        ...
        <div class="mr-2 flex items-center">
          <img title="字号" src="/text.svg" class="w-6 mr-2" alt="Font size"/>
          <input
              v-model="size_"
              type="number"
              min="12"
        ...
        <div class="mr-2 flex items-center">
          <img title="字体" src="/text-family.svg" class="w-4 mr-2" alt="Font family"/>
        ...
        <div
            ...
            @click="onDelete">
          <img class="w-full h-full" src="/delete.svg" title="移除" alt="delete object"/>
        </div>
      </tapout-component>
    </toolbar-component>
    <tapout-component
